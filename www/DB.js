	...
	insertCde: function(oCde,callback) {
		madb.transaction(
			function(tx) {
				...
				var params = [o.Ref,o.DateC,o.Vendeur,o.Societe,o.NumTva,o.RemVen,o.Civil0,o.Responsable,o.Civil1,o.Prenom1,o.Nom1,o.Civil2,o.Prenom2,o.Nom2,o.Adresse,o.CP,o.Ville,o.Tel1,o.Tel2,o.Gsm1,o.Gsm2,o.Email,
								o.Remarque,o.Fractionner,o.NbFraction,o.FactEnsSiege,o.TotalTarif,o.PrixVente,o.Remise,o.Reprise,o.Frais,o.GenreFrais,o.TotalNet,o.Financement,o.MontantFin,o.Exoneration,o.TotalTVAC,
								o.Acompte,o.AcompteCarte,o.AcompteEspece,o.AcompteCheque,o.AcompteAutre,o.SoldeAcompte,o.DateA,o.Signature1,o.Signature2];
				tx.executeSql(sql, params);
			},
			self.txErrorHandler,
			function(tx) {
